...
public interface PyramidSolitaireModel<K> {
   ...
   * pyramid shape having the specified number of rows, followed by the specified number of
   ...
   *                  a full pyramid and draw pile cannot be dealt with the given sizes,
